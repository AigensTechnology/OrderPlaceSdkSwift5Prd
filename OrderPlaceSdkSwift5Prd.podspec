...
s.homepage = "https://github.com/AigensTechnology/OrderPlaceSdkSwift5Prd"
...
ali.libraries = 'z', 'c++'
ali.dependency 'OrderPlaceSdkSwift5Prd/Core'
end
...
wechat.dependency 'OrderPlaceSdkSwift5Prd/Core'
end
...
sa.dependency 'OrderPlaceSdkSwift5Prd/Core'
end
